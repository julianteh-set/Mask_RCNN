# Mask R-CNN for Applied Anonymization of Persons and Vehicles

This is a fork of [Mask-RCNN](https://github.com/matterport/Mask_RCNN) which strips down the implementation to only include masking, and utilizes Tkinter to present an application GUI. 
